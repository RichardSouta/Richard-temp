...
class ChatPresenter extends BasePresenter
{
  public $id;
   ...
   if (!($this->user->isLoggedIn())){
	 ...
	 if(empty($chats[0]['user_id']))  {$this->flashMessage('Žádné konverzace k zobrazení. Zahajte nějakou přes symbol zprávy na profilu předmětu nebo uživatele.'); $this->redirect('Homepage:'); }
